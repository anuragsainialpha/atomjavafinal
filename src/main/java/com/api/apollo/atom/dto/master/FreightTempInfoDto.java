...
@Setter
@NoArgsConstructor
public class FreightTempInfoDto {

    @JsonProperty("recId")
    @SerializedName(value = "recId")
    ...
    public FreightTempInfoDto(FreightTemp freight) {
        this.recId = freight.getId();
        ...
        this.errorMessage = freight.getErrorMessage();
    }
}
