...
@Setter
@NoArgsConstructor
public class MtCustomerInfoDto {
    ...
    public MtCustomerInfoDto(MTCustomer MtCustomer) {

        this.insertUser = MtCustomer.getInsertUser();
        this.updateUser = MtCustomer.getUpdateUser();
        this.insertDate = MtCustomer.getInsertDate();
        this.updateDate = MtCustomer.getUpdateDate();
