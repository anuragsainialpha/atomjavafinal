...
@Setter
@NoArgsConstructor
public class MtIncotermsInfoDto {
    ...
    public MtIncotermsInfoDto(MtIncoterms MtIncoterms) {

        this.insertUser = MtIncoterms.getInsertUser();
        this.updateUser = MtIncoterms.getUpdateUser();
        this.insertDate = MtIncoterms.getInsertDate();
        this.updateDate = MtIncoterms.getUpdateDate();
