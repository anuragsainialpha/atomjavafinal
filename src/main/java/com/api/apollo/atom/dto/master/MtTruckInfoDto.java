...
public class MtTruckInfoDto {
    ...
    public MtTruckInfoDto(MTTruck MtTruck) {

        this.insertUser = MtTruck.getInsertUser();
        this.updateUser = MtTruck.getUpdateUser();
        this.insertDate = MtTruck.getInsertDate();
        this.updateDate = MtTruck.getUpdateDate();
